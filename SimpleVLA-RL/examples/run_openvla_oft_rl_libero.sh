...
# OpenVLA-OFT RL on LIBERO — runs inside simplevla-rl-rocm.sif (Apptainer).
# Submit from SimpleVLA-RL root:  sbatch examples/run_openvla_oft_rl_libero.sh
# Example: SFT_MODEL_PATH=checkpoints/openvla-oft-sft sbatch examples/run_openvla_oft_rl_libero.sh
