...
Evaluates a model in a real-world s_bot environment.
"""
...
sys.path.append(".")
from experiments.robot.s_bot.s_bot_utils import (
    get_s_bot_env,
    get_s_bot_image,
    get_s_bot_wrist_images,
    get_next_task_label,
    save_rollout_video,
)
...
class GenerateConfig:
    ...
    #################################################################################################################
    # s_bot environment-specific parameters
    #################################################################################################################
...
def prepare_observation(obs, resize_size):
    ...
    img = get_s_bot_image(obs)
    left_wrist_img, right_wrist_img = get_s_bot_wrist_images(obs)
...
def run_episode(
    ...
    """Run a single episode in the s_bot environment."""
...
@draccus.wrap()
def eval_s_bot(cfg: GenerateConfig) -> None:
    """Main function to evaluate a trained policy in a real-world s_bot environment."""
